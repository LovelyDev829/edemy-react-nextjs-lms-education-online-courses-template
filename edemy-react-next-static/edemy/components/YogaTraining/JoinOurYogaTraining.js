                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-12">
                            <div className="experience-content">
                                ...
                                <h2 className="playfair-display-font">200hr, 300hr & 500hr Certified Online Yoga courses</h2>
                                ...
                                <ul className="features-list">
                                    <li><i className="bx bx-check"></i> Receive a Yoga Alliance Certificate</li>
                                    <li><i className="bx bx-check"></i> 100hrs of Live Streaming Zoom classNamees</li>
                                    <li><i className="bx bx-check"></i> Watch Video Modules in Your Free Time</li>
                                    <li><i className="bx bx-check"></i> Flex Schedule with Extended Time from Yoga Alliance</li>
                                    <li><i className="bx bx-check"></i> Practice Traditional Hatha and vinyasa Yoga</li>
                                    <li><i className="bx bx-check"></i> Bonus Aerial & Acro Yoga Workshops</li>
                                </ul>
